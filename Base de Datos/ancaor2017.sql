...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-02-2017 a las 23:45:20
...
(3, 'About', 'about.phtml', 1, 1, 'http://localhost/ancaor2017/about', 0),
(4, 'Blog', '', 1, 2, 'http://www.blog.ancaor.com', 0);
...
(1, 'Ancaor', 'tnTJFYRbx7KJeaUFMnqx9DNJP2OnP2CbPAnnLo/jCTI=+/0LPdc1>OA==', 1, 'ancaor_s1@hotmail.com', '');
...
--
ALTER TABLE `pagina`
  MODIFY `id_Pagina` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
